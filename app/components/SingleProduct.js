    ...
    <>
      ...
      >
        ...
        <aside className="row-start-2 grid grid-cols-2 2xl:w-2/3 auto-rows-min tempalte-col lg:row-start-1 lg:col-start-3 lg:col-span-3 m-5 md:mx-10 justify-start self-start text-left space-y-1 rounded-lg">
          ...
          <select
            className="col-start-1 row-start-7 bg-transparent text-slate-950 dark:text-slate-100 rounded-lg border-2 border-[--primary] border-solid py-2 w-5/6 text-xs md:w-fit md:text-base px-5 hover:scale-95 shadow-lg hover:cursor-pointer "

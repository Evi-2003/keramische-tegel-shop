export default function Loading() {
  return (
    <>
      <section className="w-4/5 lg:w-9/12 2xl:w-4/6 my-5 mx-5 animate-pulse">
        ...
        <section className="overflow-auto flex-1 flex items-center p-10 rounded-lg w-full mt-5 h-96 flex-col justify-items-center shadow-md hover:shadow-lg border-2 border-solid border-primary animate-pulse bg-gradient-to-r from-slate-100 to-sky-100 dark:from-slate-900 dark:to-[--primary]"></section>
      </section>
    </>
  );
}

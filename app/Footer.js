        ...
        <>
            <footer className="bg-[--primary] dark:bg-red-950  w-full flex flex-col items-center">
                <nav className="xl:w-4/5 flex flex-col md:grid md:grid-cols-5 grid-flow-row auto-rows-max text-slate-50 p-10 relative gap-x-0 md:gap-x-5">
                    ...
                    priority
                    ></Image></Link>
                    <span className="col-start-1 row-start-1 text-lg font-bold">Pagina</span>
                    ...
                    <span className="col-start-2 row-start-1 text-lg font-bold pb-2 hover:underline hover:scale-95"><Link href="/shop" aria-label="Ga naar ons assortiment">Assortiment</Link></span>
                    ...
                    <span className="col-start-3 row-start-1 text-lg font-bold hover:scale-95 hover:underline"><Link href="/klantenservice" aria-label="Ga naar de pagina van onze klantenservice">Klantenservice</Link></span>
                    ...
                    <span className="col-start-4 row-start-1 text-lg font-bold">Showroom</span>
                    ...
                    ></Image></Link>
                    <span className="col-start-5 row-start-1 text-lg font-bold">Contact</span>
                ...
                <section className="bg-white dark:bg-black dark:text-slate-100 w-full pt-14 pb-10 items-center text-center">
                    ...
                    <span>© Copyright {new Date().getFullYear()} <br aria-hidden="true"></br> Keramische Tegel Shop is onderdeel van <br aria-hidden="true" className="md:hidden"></br><a href="https://nudetuin.nl" aria-label="Open de website van Nudetuin Sierbestrating & Kunstgras" target="_blank" className="hover:underline text-[--primary] dark:text-white font-semibold hover:scale-95">Nudetuin Sierbestrating & Kunstgras</a> <br></br><span className="text-sm">Een samenwerking met <a href="https://compushare.nl" aria-label="Open de website van CompuShare Automatisering" target="_blank" className="hover:underline text-[--primary] dark:text-white font-semibold hover:scale-90">CompuShare Automatiseringsoplossingen</a> en <a href="https://webchange.nl" aria-label="Open de website van WebChange" target="_blank" className="hover:underline text-[--primary] dark:text-white font-semibold hover:scale-95">WebChange</a></span></span>
